...
def monsters_to_kill(level, multiplier, exp_per_monster):
    ...
    Important information: Level 1 is ALWAYS 100xp Assume that the knight has the Exact ammount of exp for his current level. The level up modifier is a number greater than 1, which is multiplied times the experience of the previous level, in order to get the next level. (example modifier = 2, lvl 1 = 100xp lvl 2 = 100xp2 = 200xp, lvl 3 = 200xp2 = 400xp)
    """
    return None
